...
export function activateSubscription(accessToken: string, subscriptionPayload: SubscriptionCreateRequest): ZalgoPromise<string> {
    getLogger().info(`rest_api_create_subscription_id`);
...
export function getSubscription(accessToken: string, subscriptionPayload: SubscriptionCreateRequest): ZalgoPromise<string> {
    getLogger().info(`rest_api_create_subscription_id`);
