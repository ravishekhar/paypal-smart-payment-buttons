window.spb = function(modules) {
    ...
    function createAccessToken(clientID, targetSubject) {
                                ...
                                create: function(data) {
                                    return function(accessToken, subscriptionPayload, _ref2) {
                                        ...
                                        if (merchantID && merchantID[0]) {
                                            ...
                                            return createAccessToken(clientID, merchantID[0]).then((function(thirdPartyAccessToken) {
        ...
        init: function(_ref6) {
            ...
            var getSDKProps = memoize((function() {
                return promise_ZalgoPromise.hash({
                    ...
                    var orderID = _ref10.orderID, pageUrl = _ref10.pageUrl;
            ...
            var connectNative = memoize((function(_ref11) {
                var socket = getNativeSocket({
                    sessionUID: _ref11.sessionUID,
                ...
                var onShippingChangeListener = socket.on("onShippingChange", (function(_ref12) {
                ...
                var onApproveListener = socket.on("onApprove", (function(_ref13) {
                    var _ref13$data = _ref13.data, payerID = _ref13$data.payerID, paymentID = _ref13$data.paymentID, billingToken = _ref13$data.billingToken;
                    approved = !0;
                ...
                var onErrorListener = socket.on("onError", (function(_ref14) {
                    var message = _ref14.data.message;
